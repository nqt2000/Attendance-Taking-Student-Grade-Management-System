...
public class StudentInfoController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StudentInfoController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StudentInfoController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
...
//       String[] stds = request.getParameterValues("stdid");
//       s.setStdname(request.getParameter("stdname"));
//       s.setGender(Boolean.FALSE.equals(request.getParameter("gender")));
